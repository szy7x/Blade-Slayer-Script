...
local function getSelectedGem()
   ...
   if gui and gui:FindFirstChild("MainUI") and gui.MainUI:FindFirstChild("GemsFrame") and gui.MainUI.GemsFrame:FindFirstChild("DecomposeFrame") then
      return gui.MainUI.GemsFrame.DecomposeFrame:FindFirstChild("GemSelected") and gui.MainUI.GemsFrame.DecomposeFrame.GemSelected.Value or nil
   end
end
...
GemHackTab:CreateButton({
   Name = "Método 3: Execução Alternada",
   Callback = function()
      local selectedGem = getSelectedGem()
      if selectedGem then
         game:GetService("ReplicatedStorage").Remotes.DecomposeGem:FireServer(selectedGem)
